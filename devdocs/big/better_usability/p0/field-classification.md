...
*(Sections 4, 6, 7, 8, 9 — derivation/override rulebook, failure-scope matrix, lifecycle ingress
matrix, phase assignment, open issues — plus §5b reader-side consumers, are appended in later
steps of this document's construction; see `report0.2.md` onward for the running log.)*
